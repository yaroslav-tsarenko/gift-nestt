...
const CartDetailsPage = () => {
  return (
    <div className={styles.cartdetailspage}>
      <Main />
      <CartItems />
      <section className={styles.paymentContainerParent}>
        ...
        <div className={styles.footer}>
          <div className={styles.footerContent}>
            <div className={styles.consumerLinks}>
              ...
              <div className={styles.checkGiftCard}>
            ...
            <div className={styles.paymentLinks}>
              ...
              <div className={styles.buyWithBitcoin1}>
            ...
            <div className={styles.frameParent}>
              <div className={styles.heading3GiftOnTheGoWitParent}>
                ...
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/en-badge-web-genericpng2@2x.png"
                />
              </div>
              <img
