...
const FrameComponent3 = ({ className = "", enBadgeWebGenericpng }) => {
  return (
    <section className={[styles.frameParent, className].join(" ")}>
      <div className={styles.paymentMethodsContainerWrapper}>
        <div className={styles.paymentMethodsContainer}>
          <div className={styles.paymentMethodsHeading}>
      ...
      <div className={styles.footer}>
        <div className={styles.consumerLinks}>
          <div className={styles.consumerLinksContainer}>
          ...
          <div className={styles.businessLinksContainer}>
...
FrameComponent3.propTypes = {
  ...
  enBadgeWebGenericpng: PropTypes.string,
};
